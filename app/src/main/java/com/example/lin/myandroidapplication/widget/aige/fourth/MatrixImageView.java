...
public class MatrixImageView extends ImageView {
    ...
    private static final int MODE_DRAG = 0x00321; // 默认的触摸模式
    private static final int MODE_ZOOM = 0x00132; // 默认的触摸模式
    ...
    private void init() {
        ...
        设置图片资源
         */
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.girl_02);
        bitmap = Bitmap.createScaledBitmap(bitmap, AppUtils.getScreenWidthM(), AppUtils.getScreenHeightM(), true);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // 两点触控拖放选装
                    ...
                    if (preEventCoor != null) {
                        ...
                        currentMatrix.postRotate(r, AppUtils.getScreenWidthM() / 2, AppUtils.getScreenHeightM() / 2);
                    }
                }
                break;
        }
