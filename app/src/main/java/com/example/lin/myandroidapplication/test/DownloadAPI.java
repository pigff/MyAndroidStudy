package com.example.lin.myandroidapplication.test;
...
public class DownloadAPI {
    ...
    public DownloadAPI(String url, ProgressResponseListener listener) {
    ...
    public void downloadAPK(@NonNull String url, final File file, Subscriber<InputStream> subscriber) {
        Log.d(TAG, "downloadAPK: " + url);

        retrofit.create(TestService.class)
                .download(url)
